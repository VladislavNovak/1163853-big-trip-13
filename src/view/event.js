...
export const createEventTemplate = ({timeStart, timeEnd, type, place, price}) => {
  ...
  return (
    `<li class="trip-events__item">
      <div class="event">
        <time class="event__date" datetime="2019-03-18">${dayjs(timeStart).format(`MMM DD`)}</time>
        ...
        <div class="event__schedule">
          <p class="event__time">
            <time class="event__start-time" datetime="2019-03-18T14:30">${dayjs(timeStart).format(`HH:mm`)}</time>
            &mdash;
            <time class="event__end-time" datetime="2019-03-18T16:05">${dayjs(timeEnd).format(`HH:mm`)}</time>
          </p>
