import {createHeaderTypeTemplate} from "./templates/create-header-type-template";
import {createHeaderDestinationTemplate} from "./templates/create-header-destination-template";
